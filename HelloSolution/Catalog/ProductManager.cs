...
namespace Catalog
{
    ...
    public class ProductManager
    {
        ...
        {
            List<Product> allProducts = PrdocutDBManager.GetAllProducts();
            return allProducts;
        }
        ...
        public static bool Insert(Product product)
        {
            ...
            bool status = false;
            status = PrdocutDBManager.Insert(product);
            return status;
        }
        public static bool Update(Product product)
        {
            ...
            bool status = false;
            status = PrdocutDBManager.Update(product);
            return status;
        ...
        {
            bool status = false;
            status = PrdocutDBManager.Delete(id);
            return status;
        }
