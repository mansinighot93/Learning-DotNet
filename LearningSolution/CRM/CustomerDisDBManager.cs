...
namespace CRM
{
    public class CustomerDisDBManager
    {
        ...
        {
           connectionString = @"server=localhost;user=root;database=learningapp;password=''";
        }
        ...
        public static List<Customers> GetByLocation(string customerlocation)
        {
            List<Customers> customers=new List<Customers>();
            Customers customer=null;
        ...
        public static bool Insert(Customers newCustomer)
        {
            bool status = false;
        ...
        public static bool Update(Customers theCustomer)
        {
            bool status = false;
